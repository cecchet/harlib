...
public class HarFileReaderTest extends TestCase
{
  ...
  {
    Object[][] data = new Object[][]{{"test_files/www.frogthinker.org.har"}, {"test_files/en.wikipedia.org.har"},
        {"test_files/browser-blocking-time.har"}, {"test_files/google.com.har"},
        {"test_files/inline-scripts-block.har"}, {"test_files/softwareishard.com.har"}, {"test_files/custom-tags.har"},
        {"test_files/missing-timing.har"}, {"test_files/missing-timing2.har"}, {"test_files/juice1.har"},
        {"test_files/juice2.har"}, {"test_files/juice3.har"}, {"test_files/fire1.har"}, {"test_files/fire2.har"},
        {"test_files/mmap1.har"}, {"test_files/mmap2.har"}};
